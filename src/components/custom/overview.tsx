...
export const Overview = () => {
  ...
  return (
    ...
    <motion.div
      key="overview"
      className="max-w-4xl mx-auto md:mt-16"
    ...
    >
             ...
             <div className="rounded-xl p-6 flex flex-row items-stretch gap-6 leading-relaxed text-left max-w-4xl mx-auto mb-8 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700">
                                                                                                                                                                                                                                                                               {/* Profile Picture */}
