...
const PATH: PathStage[] = [
  ...
  },
  {
    tag: 'continual_v2',
    icon: RefreshCw,
    title: 'Continual Learning · Context & Harness',
    context: 'adapt models at the context and harness level — KV cache, in-context learning, memory scaffolds, tool & agent harnesses, unlearning — instead of weight retraining',
