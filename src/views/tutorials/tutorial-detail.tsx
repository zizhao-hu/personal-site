...
import { GitSaveGame } from "@/components/custom/git-save-game";
...
const TUTORIAL_COMPONENTS: Record<string, React.ComponentType> = {
  'git-save-game': GitSaveGame,
};
...
export const TutorialDetail = ({ slugOverride }: { slugOverride?: string }) => {
    ...
    <div className="flex flex-col min-h-dvh bg-background">
      ...
      <main className="flex-1 overflow-y-auto pb-24">
        <article className="max-w-4xl mx-auto px-4 sm:px-6 py-6">
          ...
          {/* Embedded Component */}
          {tutorial.componentKey && TUTORIAL_COMPONENTS[tutorial.componentKey] && (() => {
            const EmbeddedComponent = TUTORIAL_COMPONENTS[tutorial.componentKey!];
