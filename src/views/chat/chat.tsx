...
export function Chat() {
  ...
  // Handle initial question from navigation (via ?q= search param)
  const hasProcessedInitialQuestionRef = useRef(false);

  useEffect(() => {
    const initialQuestion = searchParams.get('q');
    if (initialQuestion && !hasProcessedInitialQuestionRef.current) {
      console.log("Received initial question from navigation:", initialQuestion);
