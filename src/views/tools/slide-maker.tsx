...
// Dynamic imports for libraries that use Node.js APIs
// pptxgenjs uses node:fs/node:https which fails webpack build
type PptxGenType = typeof import('pptxgenjs').default;
            ...
            <div className="flex-1 overflow-hidden flex flex-col"
                ...
                <div className="flex items-center justify-between px-4 py-2 border-b border-border bg-muted/30">
                    <div className="flex items-center gap-3">
                        <button onClick={() => router.push('/tools')} className="text-xs text-muted-foreground hover:text-foreground flex items-center gap-1 font-heading">
